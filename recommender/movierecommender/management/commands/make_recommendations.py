...
def check_valid_genres(genres: str) -> bool:
    return bool(genres and not genres.isspace()) and genres != 'na'
...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        # Start to generate recommendations for unwatched movies
        for unwatched_movie in unwatched_movies:
            ...
            for watched_movie in watched_movies:
                # Calculate the similarity between unwatched_movie and watched_movie
